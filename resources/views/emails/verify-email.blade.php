...
<table width="480" cellpadding="0" cellspacing="0" style="background-color:#111115;border:1px solid #27272f;border-radius:12px;overflow:hidden;">
    ...
    <tr><td style="padding:0 32px 24px;">
        <h1 style="font-size:22px;font-weight:700;color:#f1f0f5;margin:0 0 12px;text-align:center;">Confirm your email address</h1>
        <p style="font-size:14px;line-height:1.6;color:#8b8a98;margin:0 0 24px;text-align:center;">
            Click the button below to verify your email and activate your Relay Cloud account.
        </p>
        ...
        <p style="font-size:12px;color:#4f4e5c;margin:20px 0 0;text-align:center;">
            This link expires in 60 minutes. If you didn't create a Relay Cloud account, ignore this email.
        </p>
    </td></tr>
