...
<div style="margin-bottom: 32px;">
    ...
    <p class="page-subtitle">Set up a new Relay WebSocket project.</p>
</div>
...
<div class="card" style="max-width: 560px;">
    @if(!$canCreate)
        <div class="alert alert-warning">
            ...
            <a href="{{ route('billing.index') }}" style="color:var(--accent); text-decoration:underline; margin-left:4px;">Upgrade your plan</a> to create more.
        </div>
    @else
        @if($currentCount >= $maxProjects - 1 && $currentCount > 0)
            <div class="alert alert-warning">
                You're using {{ $currentCount }} of {{ $maxProjects }} project{{ $maxProjects === 1 ? '' : 's' }} on your plan.
                This will be your last available slot.
            </div>
        @endif
    @endif
